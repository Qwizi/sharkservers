...
from shark_api.auth.utils import register_user, get_current_active_user, get_admin_user
from shark_api.roles.models import Role
from shark_api.users.enums import UsersAdminEventsEnum
from shark_api.users.exceptions import UserNotFound
from shark_api.users.models import User
from shark_api.users.schemas import UserOutWithEmail, CreateUserSchema
from shark_api.users.utils import _admin_get_users, _admin_get_user, _admin_create_user, _admin_delete_user
