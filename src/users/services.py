...
from src.users.schemas import ChangeUsernameSchema, ChangePasswordSchema, ChangeDisplayRoleSchema, CreateUserSchema


class UserService(BaseService):
    @staticmethod
    async def change_username(user: User, change_username_data: ChangeUsernameSchema) -> User:
        """
    ...
    @staticmethod
    async def change_password(user: User, change_password_data: ChangePasswordSchema) -> User:
        """
