...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user"],
            ["users.id"],
            name="fk_users_usersessions_users_user_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["usersession"],
            ["user_sessions.id"],
            name="fk_users_usersessions_user_sessions_usersession_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["like"],
            ["forum_reputation.id"],
            name="fk_posts_likes_forum_reputation_like_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["post"],
            ["forum_posts.id"],
            name="fk_posts_likes_forum_posts_post_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["thread"],
            ["forum_threads.id"],
            name="fk_threads_threadmetas_forum_threads_thread_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["threadmeta"],
            ["forum_threads_meta.id"],
            name="fk_threads_threadmetas_forum_threads_meta_threadmeta_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
