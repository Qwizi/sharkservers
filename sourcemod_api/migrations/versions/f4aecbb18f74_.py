...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["admin_id"],
            ["sm_admins.id"],
            name="fk_sm_admins_groups_sm_admins_admin_id_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["sm_groups.id"],
            name="fk_sm_admins_groups_sm_groups_group_id_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["admin_id"],
            ["sm_admins.id"],
            name="fk_admins_groups_sm_admins_admin_id_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["sm_groups.id"],
            name="fk_admins_groups_sm_groups_group_id_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
