...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "fk_admins_groups_sm_groups_group_id", "admins_groups", type_="foreignkey"
    )
    op.drop_constraint(
        "fk_admins_groups_sm_admins_admin_id", "admins_groups", type_="foreignkey"
    )
    op.create_foreign_key(
        "fk_admins_groups_sm_groups_group_id_id",
        "admins_groups",
        "sm_groups",
        ["group_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_admins_groups_sm_admins_admin_id_id",
        "admins_groups",
        "sm_admins",
        ["admin_id"],
        ["id"],
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "fk_admins_groups_sm_admins_admin_id_id", "admins_groups", type_="foreignkey"
    )
    op.drop_constraint(
        "fk_admins_groups_sm_groups_group_id_id", "admins_groups", type_="foreignkey"
    )
    op.create_foreign_key(
        "fk_admins_groups_sm_admins_admin_id",
        "admins_groups",
        "sm_admins",
        ["admin"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_admins_groups_sm_groups_group_id",
        "admins_groups",
        "sm_groups",
        ["group"],
        ["id"],
