...
import type { Page_Scope_CXR_ } from '../models/Page_Scope_CXR_';
import type { Scope_CXR } from '../models/Scope_CXR';
...
export class AdminScopesService {
    ...
    public adminGetScopes(
        page: number = 1,
        size: number = 50,
    ): CancelablePromise<Page_Scope_CXR_> {
